...
export class ValetsResolver {
  ...
  async assignValet(
    ...
    // Use bookingTimeline in a meaningful way to satisfy the linter
    console.log(
      `Booking timeline created with status: ${bookingTimeline.status} for valet ID: ${bookingTimeline.valetId}`,
    )
